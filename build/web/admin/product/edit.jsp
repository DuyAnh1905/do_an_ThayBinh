                            ...
                            <div class="bg-light rounded h-100 p-4">
                                ...
                                <form action="EditProductServlet" method="post">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-text">We'll never share your thumbnail with anyone else.</div>
                                    </div>

                                    <div class="mb-3">
                                        <label for="price" class="form-label">Price:</label>
                                        <input name="price" value="${product.price}" type="number" class="form-control" id="price" required min="0" step="0.01">
                                        <div class="form-text">We'll never share your price with anyone else.</div>
                                    </div>

                                    <div class="mb-3">
                                        <label for="quantity" class="form-label">Quantity:</label>
                                        <input name="quantity" value="${product.quantity}" type="number" class="form-control" id="quantity" min="0" required>
